...
OBJS = $L/counters.o $C/create.o $B/box.o $L/memory.o $S/solve.o $P/puzzle.o $M/build.c $M/unique.c
...
sudoku.o: $L/counters.h $C/create.h $B/box.h $L/memory.h $S/solve.h $P/puzzle.h $M/build.h $M/unique.h
